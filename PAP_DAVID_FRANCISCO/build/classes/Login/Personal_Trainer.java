 ...
 * @author Saraiva
 */
public class Personal_Trainer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("PAINEL DE LOGIN PERSONAL");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       ...
       String senha = new String(caixatexto2.getPassword());
        if(nome.equals("PT001") && senha.equals("001personal") || nome.equals("PT002") && senha.equals("002personal"))
        {
       Personal_opcoes tela = new Personal_opcoes();
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Personal_Trainer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Personal_Trainer().setVisible(true);
            }
        });
    }
